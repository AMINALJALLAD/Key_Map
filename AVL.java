...
//		amin.remove(4, true);
	//	amin.remove(4, true);
//		amin.addKey("5", 5, true);
//		amin.addKey("70", 70, true);
//		amin.addKey("80", 80, true);
//		amin.addKey("90", 90, true);
//		amin.addKey("60", 60, true);
//		amin.addKey("40", 40, true);
//		amin.addKey("30", 30, true);
//		amin.remove(11, true);
//		amin.remove(0, true);
//
//		amin.remove(35, true);
...
//		amin.printThat2();
//		System.out.println();
//		Leaf sixteen = amin.addKey("16", 16);
//		amin.inOrderReading();
//		System.out.println("************************************");
//		amin.printThat();
//		System.out.println("root is " + amin.root);
//		System.out.println();
//		amin.addKey("20", 20);
//		amin.inOrderReading();
//		System.out.println("************************************");
//		System.out.println();
//		Leaf nineteen = amin.addKey("19", 19);
//		amin.inOrderReading();
//		System.out.println("************************************");
//		System.out.println();
//		Leaf seventeen = amin.addKey("17", 17);
//		amin.inOrderReading();
//		System.out.println("************************************");
//		amin.printThat();
//		System.out.println("root is " + amin.root);
